...
public: 
    ...
    Eigen::MatrixXd makeScancontext( pcl::PointCloud<pcl::PointXYZINormal> & _scan_down );
    ...
    // User-side API
    void makeAndSaveScancontextAndKeys( pcl::PointCloud<pcl::PointXYZINormal> & _scan_down );
