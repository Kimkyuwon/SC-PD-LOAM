...
MatrixXd SCManager::makeScancontext( pcl::PointCloud<pcl::PointXYZINormal> & _scan_down )
{
...
void SCManager::makeAndSaveScancontextAndKeys( pcl::PointCloud<pcl::PointXYZINormal> & _scan_down )
{
